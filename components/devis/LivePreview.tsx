      ...
      generateQuoteHtml(
        {
          ...
          clientCompanyName: clientInfo.companyName || null,
          clientSiret:       clientInfo.siret || null,
          contactName:       clientInfo.contactName || null,
          contactRole:       clientInfo.contactRole || null,
